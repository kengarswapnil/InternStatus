      ...
      <div className="px-6 py-4 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-5">
        <div className="flex flex-wrap items-center gap-2 md:gap-3 text-sm font-medium flex-1">
          <Link
            ...
            className="text-[23px] font-black tracking-tighter text-[#6C5CE7] mr-6 whitespace-nowrap no-underline flex items-center transition-all duration-300 hover:opacity-80"
          >
            InternStatus
